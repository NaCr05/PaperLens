export const PROVIDER_IDS = ["local-codex", "openai", "mimo"];
export const INVOCATION_MODES = ["translate", "chat", "auto", "repository"];
  ...
  if (selected !== "local-codex" && repositoryRequired) {
    if (availability?.["local-codex"]) {
      return {
        ...
        payload,
        fallbackReason: "代码实现问题需要实时核实论文仓库，已切换到本机 Codex",
      };
    }
    return {
      provider: "openai",
